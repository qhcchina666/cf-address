...
const i18n = {
  zh: {
    ...
    footer:'© QHC 地址生成器 | 所有数据均为随机生成，仅供测试使用 | 不代表真实可收件地址',
  ...
  en: {
    ...
    footer:'© QHC Address Generator | All data is randomly generated for testing purposes only | Does not represent real deliverable addresses',
  ...
  ja: {
    ...
    footer:'© QHC アドレスジェネレーター | すべてのデータはテスト目的でランダムに生成されています | 実際の配送先住所を表すものではありません',
  ...
  ko: {
    ...
    footer:'© QHC 주소 생성기 | 모든 데이터는 테스트 목적으로 무작위 생성됩니다 | 실제 배송 가능한 주소를 나타내지 않습니다',
